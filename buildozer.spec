...
# (str) Package name
package.name = dokedhar

# (str) Package domain (needed for android/ios packaging)
package.domain = org.alavi

# (str) Source code where the main.py live
source.dir = .

# (list) Source files to include (leave empty to include all the files)
source.include_exts = py,png,jpg,jpeg,kv,atlas,otf,ttf,wav,mp3,ogg,json
...
fullscreen = 1
icon.filename = %(source.dir)s/dokedar_icon.png
...
#       [app]
#       title = Dokeh Dar # This is not a comment, it is part of the title.
#
#   Warning: Indented text is treated as a multiline string - i.e.
#       [app]
#       title = Dokeh Dar
#          package.name = dokedhar # This is all part of the title.
#
